                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.content-categories.update", [$contentCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $contentCategory->description) }}">
...
@if(isset($contentCategory) && $contentCategory->photo)
      ...
      this.options.thumbnail.call(this, file, '{{ $contentCategory->photo->getUrl('thumb') }}')
