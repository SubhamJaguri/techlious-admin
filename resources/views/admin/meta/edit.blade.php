                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.meta.update", [$metum->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('object') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="object" id="object" value="{{ old('object', $metum->object) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('model') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="model" id="model" value="{{ old('model', $metum->model) }}">
                            @if($errors->has('model'))
                        ...
                        <div class="form-group {{ $errors->has('key') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="key" id="key" value="{{ old('key', $metum->key) }}" required>
                            @if($errors->has('key'))
                        ...
                        <div class="form-group {{ $errors->has('value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="value" id="value" value="{{ old('value', $metum->value) }}" required>
                            @if($errors->has('value'))
