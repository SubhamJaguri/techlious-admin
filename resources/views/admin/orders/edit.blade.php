                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $order->price) }}" step="0.01" required>
                            @if($errors->has('price'))
                        ...
                        <div class="form-group {{ $errors->has('is_valid') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_valid" id="is_valid" value="1" {{ $order->is_valid || old('is_valid', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('valid_from') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="valid_from" id="valid_from" value="{{ old('valid_from', $order->valid_from) }}">
                        ...
                        <div class="form-group {{ $errors->has('valid_till') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="valid_till" id="valid_till" value="{{ old('valid_till', $order->valid_till) }}">
