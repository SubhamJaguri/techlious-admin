                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.locations.update", [$location->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('from_main_gate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="from_main_gate" id="from_main_gate" value="{{ old('from_main_gate', $location->from_main_gate) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude', $location->longitude) }}" step="0.01">
